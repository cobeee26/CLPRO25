    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-100 flex flex-col items-center justify-center p-4">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 max-w-md mb-8">
          {user?.role === 'student' ? (
            <>
              <div className={`px-3 py-2 rounded-lg text-center text-sm font-medium transition-all duration-300 ${loadingProgress >= 25
                  ? "bg-blue-100 text-blue-600 shadow-sm"
                  : "bg-gray-100 text-gray-400"
                }`}>
                Grades
              </div>
              <div className={`px-3 py-2 rounded-lg text-center text-sm font-medium transition-all duration-300 ${loadingProgress >= 50
                  ? "bg-green-100 text-green-600 shadow-sm"
                  : "bg-gray-100 text-gray-400"
                }`}>
                Performance
              </div>
              <div className={`px-3 py-2 rounded-lg text-center text-sm font-medium transition-all duration-300 ${loadingProgress >= 75
                  ? "bg-purple-100 text-purple-600 shadow-sm"
                  : "bg-gray-100 text-gray-400"
                }`}>
                Analysis
              </div>
              <div className={`px-3 py-2 rounded-lg text-center text-sm font-medium transition-all duration-300 ${loadingProgress >= 100
