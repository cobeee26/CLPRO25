              ...
              <div className="flex flex-col lg:flex-row items-start lg:items-center gap-8">
                <div className="relative flex-shrink-0">
                  <div className="w-28 h-28 rounded-3xl overflow-hidden shadow-2xl border-4 border-gray-200 bg-gradient-to-br from-purple-100 to-blue-100">
                    ...
                    <div
                      className={`w-full h-full flex items-center justify-center text-5xl ${(!user.profile_picture_url ||
                        user.profile_picture_url.trim() === "") &&
                        !photoPreview
                        ? ""
                        : "hidden"
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                          ...
                          <input
                            ...
                            className={`w-full px-4 py-3 bg-white border rounded-xl text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent cursor-text ${profileErrors.first_name
                              ? "border-red-500"
                              : "border-gray-300"
                              }`}
                        ...
                        <div>
                          ...
                          <input
                            ...
                            onChange={handleProfileChange}
                            className={`w-full px-4 py-3 bg-white border rounded-xl text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent cursor-text ${profileErrors.last_name
                              ? "border-red-500"
                              : "border-gray-300"
                              }`}
                ...
                <div className="bg-white backdrop-blur-sm border border-gray-200 rounded-3xl p-8 shadow-2xl">
                  <div className="flex items-center justify-between mb-8">
                    ...
                    <button
                      ...
                      className={`px-6 py-3 rounded-xl font-medium transition-all duration-200 shadow-sm border cursor-pointer flex items-center gap-2 ${showPasswordForm
                        ...
                        <div>
                          ...
                          <div className="relative">
                            <input
                              ...
                              className={`w-full px-4 py-3 bg-white border rounded-xl text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-transparent cursor-text ${passwordErrors.current_password
                                ? "border-red-500"
                                : "border-gray-300"
                                }`}
                        ...
                        <div>
                          ...
                          <div className="relative">
                            <input
                              ...
                              onChange={handlePasswordChange}
                              className={`w-full px-4 py-3 bg-white border rounded-xl text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-transparent cursor-text ${passwordErrors.new_password
                                ? "border-red-500"
                                : "border-gray-300"
                                }`}
                        ...
                        <div>
                          ...
                          <div className="relative">
                            <input
                              ...
                              onChange={handlePasswordChange}
                              className={`w-full px-4 py-3 bg-white border rounded-xl text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-transparent cursor-text ${passwordErrors.confirm_password
                                ? "border-red-500"
                                : "border-gray-300"
                                }`}
