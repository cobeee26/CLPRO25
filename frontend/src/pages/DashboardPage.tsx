          ...
          <div className="bg-white border border-gray-300 rounded-2xl shadow-xl w-full max-w-4xl max-h-[90vh] overflow-hidden">
            ...
            <div className="flex border-b border-gray-200">
              <button
                ...
                className={`flex-1 px-6 py-4 text-sm font-semibold transition-all duration-200 ${activeTab === 'schedule'
              ...
              <button
                ...
                className={`flex-1 px-6 py-4 text-sm font-semibold transition-all duration-200 ${activeTab === 'announcement'
                    ? 'text-amber-600 bg-amber-50 border-b-2 border-amber-500'
                    : 'text-gray-600 hover:text-gray-900 hover:bg-gray-50'
                  } cursor-pointer`}
              >
