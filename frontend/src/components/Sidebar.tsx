  ...
  return (
    <>
      <div
        ...
        className={`dashboard-sidebar ${sidebarOpen ? "open translate-x-0" : "-translate-x-full"
        ...
        <div className="p-3 border-t border-gray-200 mt-auto">
          <div className="flex items-center space-x-3 mb-3">
            <div className="relative w-10 h-10 rounded-xl overflow-hidden shadow-lg flex-shrink-0">
              ...
              <div
                className={`w-full h-full bg-gradient-to-br ${getRoleAvatarGradient()} flex items-center justify-center ${!user?.profile_picture_url ||
                    user.profile_picture_url.trim() === ""
                    ? ""
                    : "hidden"
                  }`}
